...
-- Version: 1.2 | Last Updated: 2026-08-06 | Author: System Analyst AI + مراجعة تنفيذية
--
...
--
-- سجل التغيير v1.2 (2026-08-06):
--   [I18N-01] المنصة صارت ثلاثية اللغة (عربي/إنجليزي/إندونيسي). أُضيفت:
--             hadiths.translation_en · word_definitions.definition_en
--             collections/books/chapters.name_en
--             العربية إلزامية؛ البقية اختيارية مع رجوع للعربية عند الغياب.
...
CREATE TABLE hadiths (
    ...
    translation_id TEXT,                   -- الترجمة الإندونيسية
    translation_en TEXT,                   -- [v1.2] الترجمة الإنجليزية
    grade          hadith_grade,
    explanation    TEXT,
...
CREATE TABLE word_definitions (
    ...
    definition_id TEXT,
    definition_en TEXT,                    -- [v1.2] ثلاثي اللغة
    audio_url     TEXT
);
